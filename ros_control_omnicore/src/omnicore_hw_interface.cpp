...
namespace ros_control_omnicore
{
   OmnicoreHWInterface::OmnicoreHWInterface(const ros::NodeHandle &nh) : nh(nh)
   {
      ...
      // subscriber per ricevere i comandi in velocità
      sub_joint_des_ = _nh.subscribe("joint_des", 0, &OmnicoreHWInterface::joint_des_cb, this);
      sub_joint_cmd_ = _nh.subscribe("joint_cmd", 0, &OmnicoreHWInterface::joint_cmd_cb, this);
   }
   ...
   void OmnicoreHWInterface::joint_des_cb(sensor_msgs::JointStateConstPtr data)
   {
      joint_velocity_command[0] = data->velocity[0];
      joint_velocity_command[1] = data->velocity[1];
      joint_velocity_command[2] = data->velocity[2];
      joint_velocity_command[3] = data->velocity[3];
      joint_velocity_command[4] = data->velocity[4];
      joint_velocity_command[5] = data->velocity[5];
      joint_velocity_command[6] = data->velocity[6];
      // ROS_INFO("velocità desiderata 0: %f", data->velocity[0]); //debug
   }

   void OmnicoreHWInterface::joint_cmd_cb(sensor_msgs::JointStateConstPtr data)
   {
      joint_velocity_command[0] = data->velocity[0];
      joint_velocity_command[1] = data->velocity[1];
      joint_velocity_command[2] = data->velocity[2];
      ...
      joint_velocity_command[5] = data->velocity[5];
      joint_velocity_command[6] = data->velocity[6];
      //("velocità desiderata 0: %f", joint_velocity_command[0]); //debug
   }
