...
namespace ros_control_omnicore
{
	...
	public:
		...
		void joint_des_cb(sensor_msgs::JointStateConstPtr data);
		void joint_cmd_cb(sensor_msgs::JointStateConstPtr data);
	...
	private:
		...
		ros::NodeHandle _nh;
		ros::Subscriber sub_joint_des_, sub_joint_cmd_;
