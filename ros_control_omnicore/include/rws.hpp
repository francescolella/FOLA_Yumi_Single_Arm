...
public:
	...
	void ON_freeDrive();
	void OFF_freeDrive();
	void freeDrive_cb(std_msgs::Int8ConstPtr data);
	void gripper_cb(std_msgs::Int8ConstPtr msg);
	ros::Subscriber _freeDrive_sub, _cmd_gripper_sub, sub_switch_;

private:
	ros::NodeHandle _nh;
	void Close_gripper();
	void Open_gripper();
	void switch_contr_cb(std_msgs::BoolConstPtr data);
